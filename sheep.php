...
<?php
$count=1;
$sel_query="SELECT `id`, `type`, `breed`, `number`, `name`, `gender`, `offspring`, `parents`, `date_purchased`, `date_sold` FROM `animals` WHERE `type`= 'Sheep' && `user_id`='$cur_user'";
